	...
	<div class="content-wrapper">
		<div class="flex">
			...
			<div class="flex-wrapper second">
				<h1 class = "title">
					<div class="title-mask">
						<div class="word" bind:this={titleWord1Element}>akash</div>
					</div><br> 
					<div class="title-mask">
						<div class="word" bind:this={titleWord2Element}>Pandey</div>
					</div>
				</h1>
				<div class="occupation mask">
					<p class = "paragraph" bind:this={shortDetailsElement}>
						Embedded Systems | AI & Machine Learning | Autonomous Navigation
					</p>
				</div>
			...
			<div class="parallax-wrapper home-back" bind:this={backgroundContainerElement}>
				{#await loadImage("assets/imgs/raimond-klavins-lTRBvHGabyw-unsplash.jpg") then src}
...
#content-container
	...
	&::after
		...
		width: 100%
		height: 100%
		background-image: url('/assets/imgs/grain1.webp') // or use CSS-generated grain here
		opacity: 0.1
