			...
			<div class="wrapper" class:mobileMenuActive>
				<ul class="nav-list">
					{#key mobileMenuActive}
						...
						<li class="mobile">
							<a href="mailto:akashpandey20200@gmail.com" target="_blank" in:mobileTransitionSwitcher={{ delay: 350 }}>Email</a>
						</li>
						<li use:introAnimation={{ delay: 1300 }}>
							<a href="https://github.com/AKASH789585" target="_blank" in:mobileTransitionSwitcher={{ delay: 400 }}>Github</a>
						</li>
					{/key}
				</ul>
			</div>
